        ...
        <div className="container relative mx-auto px-4 py-20 max-w-[76rem] mt-[4rem]">
          <div className="max-w-3xl">
            ...
            <nav className="flex items-center text-white text-sm mt-[1rem]">
              ...
              <span className="mx-2 text-gray-400">›</span>
              <span className="text-gray-300 font-medium">TAPES</span>
              <span className="mx-2 text-gray-400">›</span>
              <span className="text-gray-300 font-medium">WEATHER PROOF MAISTIC TAPES</span>
            </nav>
          </div>
        </div>
      </section>
