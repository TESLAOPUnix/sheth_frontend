...
export default function Component() {
  ...
  const handleCardClick = (slug: string) => {
    router.push(`/dowells/glands/double-cmp/arm/${slug}`);
  };
                ...
                <div className="container relative mx-auto px-4 py-20 max-w-[76rem] mt-[4rem]">
                  <div className="max-w-3xl">
                    ...
                    <nav className="flex items-center text-white text-sm mt-[1rem]">
                      ...
                      <span className="mx-2 text-gray-400">›</span>
                      <span className="text-gray-300 font-medium">GLANDS</span>
                      <span className="mx-2 text-gray-400">›</span>
                      <span className="text-gray-300 font-medium">DOUBLE-CMP</span>
                      <span className="mx-2 text-gray-400">›</span>
                      <span className="text-gray-300 font-medium">ARMOURED</span>
                    </nav>
                  </div>
                </div>
              </section>
